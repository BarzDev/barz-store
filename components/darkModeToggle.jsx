...
export default function DarkModeToggle() {
  ...
  return (
    <>
      ...
      <div className="bg-yellow-400 dark:bg-gray-800 text-white dark:text-gray-300 p-1  border-2 border-white dark:border-gray-400 overflow-hidden flex justify-center items-center rounded-full">
